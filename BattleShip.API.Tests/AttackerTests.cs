...
namespace Battleship.Tests
{
    public class AttackerTests
    {
        ...
        [InlineData(10, 10, 0, 0, 0, 0, ShipType.Carrier, BoardCellStatus.Hit)]
        [InlineData(10, 10, 0, 0, 0, 1, ShipType.Carrier, BoardCellStatus.Hit)]
        [InlineData(10, 10, 0, 0, 0, 2, ShipType.Carrier, BoardCellStatus.Hit)]
        [InlineData(10, 10, 0, 0, 0, 3, ShipType.Carrier, BoardCellStatus.Hit)]
        [InlineData(10, 10, 0, 0, 0, 4, ShipType.Carrier, BoardCellStatus.Hit)]
        [InlineData(10, 10, 0, 0, 5, 5, ShipType.Carrier, BoardCellStatus.Miss)]
        [InlineData(10, 10, 0, 0, 0, 5, ShipType.Carrier, BoardCellStatus.Miss)]
        [InlineData(10, 10, 0, 0, 3, 8, ShipType.Carrier, BoardCellStatus.Miss)]
        ...
        [InlineData(10, 10, 0, 0, 11, 11, ShipType.Carrier)]
        [InlineData(10, 10, 0, 0, 17, 15, ShipType.Carrier)]
